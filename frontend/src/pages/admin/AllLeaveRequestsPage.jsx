...
// applied for leave). Click a row to open that person's full leave history,
// where the admin approves/rejects individual requests.
    ...
    <DashboardLayout title="All leave requests">
      <div className="page-header">
        <div>
          ...
          <p>
            Every employee and their leave activity. Click a name to see their full history and approve or reject
            pending requests.
          </p>
        </div>
      </div>
                  ...
                  <tbody>
                    {visibleEmployees.length === 0 ? (
                      ...
                      <tr
                        ...
                        onClick={() => navigate(`/admin/users/${employee.id}/leaves`)}
                      >
