// Mirrors backend/src/utils/numberToWords.util.js - used only to show a live
// "Amount in Words" preview while reviewing an invoice before saving. The
// backend independently regenerates the authoritative value that's actually
// stored/printed, so the two never need to be imported from a shared module.
const ONES = [
