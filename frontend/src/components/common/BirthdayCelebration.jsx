...
// only rendering this once per birthday (see BirthdayCelebrationGate).
export default function BirthdayCelebration({ firstName, onDone }) {
  useEffect(() => {
  ...
  return (
    <div className="celebration-overlay" role="status" aria-live="polite">
      ...
      <div className="celebration-card">
        ...
        <h2>Happy Birthday{firstName ? `, ${firstName}` : ""}!</h2>
